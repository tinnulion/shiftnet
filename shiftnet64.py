...
class ShiftNet(torch.nn.Module):
    ...
    def __init__(self):
        ...
        layers["block_01"] = ShiftNet.__get_block(32, 32, 1)
        layers["block_02"] = ShiftNet.__get_block(32, 64, 2)
        layers["block_03"] = ShiftNet.__get_block(64, 64, 1)
        layers["block_04"] = ShiftNet.__get_block(64, 128, 2)
        layers["block_05"] = ShiftNet.__get_block(128, 128, 1)
        layers["block_06"] = ShiftNet.__get_block(128, 256, 2)
        layers["block_07"] = ShiftNet.__get_block(256, 256, 1)
        layers["block_08"] = ShiftNet.__get_block(256, 256, 1)
        layers["block_09"] = ShiftNet.__get_block(256, 256, 1)
        layers["block_10"] = ShiftNet.__get_block(256, 256, 1)
        layers["block_11"] = ShiftNet.__get_block(256, 256, 2)
        layers["block_12"] = ShiftNet.__get_block(256, 256, 1)
